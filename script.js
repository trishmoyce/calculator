...
function countClicks() {
    clickAmounts += 1;
    console.log(clickAmounts);
  }

XX.addEventListener("click", countClicks)
...
/* user enters a number, an operator, and another operator
...
btn4.addEventListener("click", numberButton);
btn5.addEventListener("click", numberButton);
btn6.addEventListener("click", numberButton);
btn7.addEventListener("click", numberButton);
btn8.addEventListener("click", numberButton);
btn9.addEventListener("click", numberButton);
btn0.addEventListener("click", numberButton);
btnadd.addEventListener("click", operatorButton);
btnsub.addEventListener("click", operatorButton);
btnmult.addEventListener("click", operatorButton);
btndiv.addEventListener("click", operatorButton);

//the calculation is performed when entering the below function and parameters, but I need the equal button to call the function
//operate(firstOp, firstNum, secondNum);
...
// after a certain amount of characters entered the calculator should stop accepting input